...
var L = (p, f, g) =>
    f in p
      ? _(p, f, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (p[f] = g),
  k = (p, f) => {
...
(function (p, f) {
  ...
  class O {
    ...
    initialize(e, t, s) {
      ...
      if (
        ((this.globalConfig = k(k({}, E), t)),
        s && (this.dictLocale = s),
        this.isTooltip())
      ) {
        const r = document.createElement("style");
        (r.textContent = q),
          (this.customStyleTags[C.Label] = document.head.appendChild(r)),
    ...
    getLocalisedString(e) {
      ...
      return !this.currentLocale || !this.dictLocale.length
        ? e
        : ((s = this.dictLocale.find((r) => r.key === e)) == null
            ? void 0
    ...
    validateGroupRule(e, t, s, r) {
      switch (r.rule) {
        case v.Required:
          (t === "radio" || t === "checkbox") &&
            (s.every((i) => !i.checked)
              ? this.setGroupInvalid(e, r)
              : this.setGroupValid(e, r));
      }
    }
            ...
            const b = Number.isFinite(h.minSize) && n.size < h.minSize,
              ...
              H =
                ...
                !h.extensions.includes(
                  n.name.split(".")[n.name.split(".").length - 1]
                ),
    ...
    validateField(e, t = !1) {
      ...
      return (
        ...
        s.isValid &&
          this.setFieldValid(
            e,
            (i = s.config) == null ? void 0 : i.successMessage
          ),
        ...
        this.validate(t).finally(() => {
          ...
          this.globalConfig.lockForm && this.unlockForm(),
            this.isValid
              ...
              : (r = this.onFailCallback) == null ||
                r.call(this, this.fields, this.groupFields);
        })
      );
    }
    setForm(e) {
      ...
      return (
        t.forEach((i) => {
          ...
          if (
            !i.validator &&
            !i.plugin &&
            (!i.rule || !Object.values(d).includes(i.rule))
          )
            throw Error(
    ...
    addRequiredGroup(e, t, s, r) {
      ...
      return (
        (this.groupFields[e] = {
          rules: [{ rule: v.Required, errorMessage: t, successMessage: r }],
          groupElem: i,
          elems: Array.from(o),
    ...
    clearFieldError(e) {
      ...
      const t = this.fields[e],
        s =
          ((i = t.config) == null ? void 0 : i.errorFieldStyle) ||
          this.globalConfig.errorFieldStyle;
      Object.keys(s).forEach((n) => {
        t.elem.style[n] = "";
      });
      const r =
        ((o = t.config) == null ? void 0 : o.successFieldStyle) ||
      ...
      Object.keys(r).forEach((n) => {
        ...
        t.elem.classList.remove(
          ...
          ((c = t.config) == null ? void 0 : c.successFieldCssClass) ||
            this.globalConfig.successFieldCssClass
        );
    }
    clearErrors() {
      var e, t;
      Object.keys(this.errorLabels).forEach((s) =>
        this.errorLabels[s].remove()
      ),
      ...
      for (const s in this.groupFields) {
        const r = this.groupFields[s],
          i =
            ((e = r.config) == null ? void 0 : e.errorFieldStyle) ||
            this.globalConfig.errorFieldStyle;
        Object.keys(i).forEach((a) => {
          r.elems.forEach((c) => {
            ...
            (c.style[a] = ""),
              c.classList.remove(
                ((n = r.config) == null ? void 0 : n.errorFieldCssClass) ||
                  this.globalConfig.errorFieldCssClass
              );
          });
        });
        const o =
          ((t = r.config) == null ? void 0 : t.successFieldStyle) ||
          this.globalConfig.successFieldStyle ||
          {};
    ...
    renderTooltip(e, t, s) {
      ...
      const {
        ...
        n =
          s || ((b = this.globalConfig.tooltip) == null ? void 0 : b.position);
      switch (n) {
        case "left": {
          (t.style.top = `${r + a / 2 - c.height / 2}px`),
            (t.style.left = `${i - c.width - F}px`);
          break;
        }
        case "top": {
          (t.style.top = `${r - c.height - F}px`),
            (t.style.left = `${i + o / 2 - c.width / 2}px`);
          break;
        }
        case "right": {
          (t.style.top = `${r + a / 2 - c.height / 2}px`),
            (t.style.left = `${i + o + F}px`);
          break;
        }
        case "bottom": {
          (t.style.top = `${r + a + F}px`),
            (t.style.left = `${i + o / 2 - c.width / 2}px`);
          break;
        }
      }
    ...
    renderFieldLabel(e, t, s, r) {
      ...
      if (!(!r && this.renderErrorsContainer(t, s)))
        if (e.type === "checkbox" || e.type === "radio") {
          ...
          ((o = (i = e.parentElement) == null ? void 0 : i.tagName) == null
            ? void 0
            : o.toLowerCase()) === "label"
            ? (c = (a = e.parentElement) == null ? void 0 : a.parentElement) ==
                null || c.appendChild(t)
            : m
    ...
    renderFieldError(e) {
        ...
        if (!t.asyncCheckPending) {
          ...
          h &&
            this.renderFieldLabel(
              t.elem,
              h,
              (r = t.config) == null ? void 0 : r.errorsContainer,
              !0
            ),
            t.elem.classList.add(
              ((i = t.config) == null ? void 0 : i.successFieldCssClass) ||
                this.globalConfig.successFieldCssClass
            );
        }
        return;
      ...
      (this.isValid = !1),
        t.elem.classList.add(
          ((o = t.config) == null ? void 0 : o.errorFieldCssClass) ||
            this.globalConfig.errorFieldCssClass
        );
      ...
      this.renderFieldLabel(
        t.elem,
        s,
        (a = t.config) == null ? void 0 : a.errorsContainer
      ),
        this.isTooltip() &&
          this.tooltips.push(
            this.renderTooltip(
              t.elem,
              s,
              (n = (c = t.config) == null ? void 0 : c.tooltip) == null
                ? void 0
                : n.position
            )
          );
        ...
        for (const o in this.groupFields) {
          ...
          if (a.isValid) {
            a.elems.forEach((h) => {
              ...
              Object.assign(
                h.style,
                ((b = a.config) == null ? void 0 : b.successFieldStyle) ||
                  this.globalConfig.successFieldStyle
              ),
                h.classList.add(
                  ((m = a.config) == null ? void 0 : m.successFieldCssClass) ||
                    this.globalConfig.successFieldCssClass
                );
            });
            ...
            n &&
              this.renderGroupLabel(
                a.groupElem,
                n,
                (t = a.config) == null ? void 0 : t.errorsContainer,
                !0
              );
            continue;
          }
          (this.isValid = !1),
            a.elems.forEach((n) => {
              ...
              Object.assign(
                n.style,
                ((h = a.config) == null ? void 0 : h.errorFieldStyle) ||
                  this.globalConfig.errorFieldStyle
              ),
                n.classList.add(
                  ((b = a.config) == null ? void 0 : b.errorFieldCssClass) ||
                    this.globalConfig.errorFieldCssClass
                );
            });
          ...
          this.renderGroupLabel(
            a.groupElem,
            c,
            (s = a.config) == null ? void 0 : s.errorsContainer
          ),
            this.isTooltip() &&
              this.tooltips.push(
                this.renderTooltip(
                  a.groupElem,
                  c,
                  (i = (r = a.config) == null ? void 0 : r.tooltip) == null
                    ? void 0
                    : i.position
                )
              );
